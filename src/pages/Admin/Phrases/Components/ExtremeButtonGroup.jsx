...
export const ExtremeButtonGroup = ({ currentExtreme, handleExtreme }) => {
  return (
    <div className="flex flex-col md:flex-row md:justify-between md:items-center rounded-2xl">
      <button
        className={twMerge(
          'px-4 py-2 text-xl md:rounded-r-none rounded-2xl text-white font-bold flex justify-center items-center transition-all hover:scale-105 bg-neutral-400 border',
      ...
      <button
        className={twMerge(
          'px-4 py-2 text-xl md:rounded-l-none rounded-2xl text-white font-bold flex justify-center items-center transition-all hover:scale-105 bg-neutral-400 border',
