...
export const ResultsFooter = () => {
    ...
    return (
        <footer className='flex flex-col justify-center items-center absolute bottom-0 w-full mb-[100px] gap-[40px]'>
            <div className='flex flex-col justify-between items-center h-[172px] w-[330px]'>
                ...
                <img src="logo/criteria/criteriaLogo.png" alt="Logo criteria" className='w-[280px] h-[70px]' />
            </div>
